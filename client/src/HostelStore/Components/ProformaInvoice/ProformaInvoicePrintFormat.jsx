...
const styles = StyleSheet.create({
    ...
    topBar: { height: 4, backgroundColor: "#10b981" },
    header: {
        flexDirection: "row",
        alignItems: "center",
    ...
    companyName: { fontSize: 18, fontWeight: "bold", color: "#065f46", letterSpacing: 0.5 },
    ...
    totalLabel: { flex: 1, textAlign: "right", fontWeight: "bold", fontSize: 9, color: "#065f46", marginRight: 10 },
    totalValue: { width: 70, textAlign: "right", fontWeight: "bold", fontSize: 9, color: "#065f46" },
    footer: {
        marginHorizontal: 20,
        marginTop: 10,
        flexDirection: "row",
