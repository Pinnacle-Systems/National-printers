...
const ProductionAllocationReport = ({
  ...
  console.log("Session Params:", { branchId, finYearId });
  ...
  const {
    ...
    error,
    refetch,
  } = useGetProductionAllocationQuery(queryParams);

  console.log("RENDER: ProductionAllocationReport", {
    branchId,
    finYearId,
    queryParams,
    allData,
  ...
  if (isError) console.error("ProductionAllocationReport: Query Error", error);

  useEffect(() => {
    console.log("EFFECT: queryParams changed", queryParams);
  }, [queryParams]);

  useEffect(() => {
    console.log("EFFECT: allData changed", allData);
  }, [allData]);
        ...
        <div className="h-[68vh] overflow-auto">
          <table className="">
            <thead className="bg-gray-200 text-gray-800 ">
              <tr className="">
                <th
                  className=" px-1 py-1.5  font-medium text-[13px]  text-gray-900  text-center  w-12"
                  rowSpan={2}
                >
